  ...
  try {
    ...
    cont.innerHTML = `
      <div class="estadisticas-grid">
        ...
        <div class="estadistica-card">
          <div class="estadistica-card__valor">RD$ ${Number(e.ingreso_cobrado).toLocaleString('es-DO')}</div>
          <div class="estadistica-card__label">Cobrado (de RD$ ${ingresoTotal.toLocaleString('es-DO')} facturado)</div>
        </div>
      </div>

  ...
  try {
    const result = await pool.query(
      `SELECT u.id, u.nombre, u.ubicacion, p.descripcion, p.anos_experiencia,
       ...
       GROUP BY u.id, u.nombre, u.ubicacion, p.descripcion, p.anos_experiencia, p.calificacion_promedio, p.total_valoraciones
  ...
  try {
    const result = await pool.query(
      `SELECT u.id, u.nombre, u.ubicacion, p.descripcion, p.anos_experiencia,
       ...
       GROUP BY u.id, u.nombre, u.ubicacion, p.descripcion, p.anos_experiencia, p.calificacion_promedio, p.total_valoraciones, f.creado_en
